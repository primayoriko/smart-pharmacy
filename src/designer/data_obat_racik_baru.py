...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(40, 130, 281, 251))
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.vNamaObat = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.vNamaObat.setContentsMargins(0, 0, 0, 0)
        self.vNamaObat.setSpacing(10)
        self.vNamaObat.setObjectName("vNamaObat")
        self.field_namaObat1 = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.field_namaObat1.setObjectName("field_namaObat1")
        self.vNamaObat.addWidget(self.field_namaObat1)
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(Dialog)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(330, 130, 81, 251))
        self.verticalLayoutWidget_2.setObjectName("verticalLayoutWidget_2")
        self.vJumlah = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_2)
        self.vJumlah.setContentsMargins(0, 0, 0, 0)
        self.vJumlah.setSpacing(10)
        self.vJumlah.setObjectName("vJumlah")
        self.field_jumlah1 = QtWidgets.QLineEdit(self.verticalLayoutWidget_2)
        self.field_jumlah1.setObjectName("field_jumlah1")
        self.vJumlah.addWidget(self.field_jumlah1)
        self.verticalLayoutWidget_3 = QtWidgets.QWidget(Dialog)
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(420, 130, 160, 251))
        self.verticalLayoutWidget_3.setObjectName("verticalLayoutWidget_3")
        self.vSatuan = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_3)
        self.vSatuan.setContentsMargins(0, 0, 0, 0)
        self.vSatuan.setSpacing(10)
        self.vSatuan.setObjectName("vSatuan")
        self.field_satuan1 = QtWidgets.QComboBox(self.verticalLayoutWidget_3)
        self.field_satuan1.setObjectName("field_satuan1")
        self.vSatuan.addWidget(self.field_satuan1)
        self.buttonBox.raise_()
        self.titleLabel.raise_()
        self.resepName.raise_()
        self.headerNamaObat.raise_()
        self.fieldNamaResep.raise_()
        self.headerJumlah.raise_()
        self.headerSatuan.raise_()
        self.verticalLayoutWidget.raise_()
        self.verticalLayoutWidget_2.raise_()
        self.verticalLayoutWidget_3.raise_()
        self.addItemsButton.raise_()
